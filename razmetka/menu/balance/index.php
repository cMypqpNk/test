...
<body > 
 ...
 <div id="logo_head"> Site Mine</div>
  <ul class="top-menu">
    ...
    <div id="container">
      <div id="content">
        <div id="content-header"><div class="content-header-text">Пополнение счёта </div>
      ...
      <div class="shop-content">
        <div class="shop-panel">
             ...
             ваш баланс <?php echo $kek;?>
             <input type="text" placeholder="введите сколько хотите пополнить" name="donat"><br><br>
             <div id="group-btn"><button type="submit" name="do_balance" class="default-btn" >задонатить</button>
             </div>
             <br>
