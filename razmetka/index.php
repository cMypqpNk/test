...
<body > 
 ...
 <div id="logo_head"> Site Mine</div>
  <ul class="top-menu">
    <li class="top"><a class="top" href="#home">Главная</a></li>
    <li class="top"><a class="top" href="menu/start/index.php">Начать играть</a></li>
    <li class="top"><a class="top" href="menu/shop/index.php">Донат</a>
      <ul class="submenu">
        <li><a class="top" href="menu/shop/index.php">Сервер 1</a></li>
        <li><a class="top" href="menu/shop/index.php">Сервер 2</a></li>
        <li><a class="top" href="menu/shop/index.php">Сервер 3</a></li>
    ...
    <div id="container">
      <div id="content">
        <div id="content-header"><div class="content-header-text">Content</div>
          
        </div>
        <?php while ($mesage =mysqli_fetch_assoc($result))
          {?>
          <div id="content-content-1">
            <div id="content-title"><?php  echo $mesage['title']; ?></div>
            <div class="image">
              <img class="image" src="<?php  echo $mesage['image'];?>">
            </div>
            <div class="info"><text>Дата поста:<?php  echo $mesage['data']; ?></text><br><br>
               <text>Кол-во просмотров записи:<?php  echo $mesage['view']; ?></text><br><br> 
               <div class="info1">
            
          
            
          
            <?php  echo $mesage['text']; ?>
            </div>
            </div>
  ...
  <?php else : ?>
    <div id="content-header-1"><div class="content-header-text-1">Login</div></div>
        <form method="post" action="index.php" class="login">
             ...
             <br>
             <a class="default-btn" href="">забыли пароль?</a>
